...
class TestUserMongo(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Подменяем коллекции в User (если нужно)
    ...
    def setUp(self):
        ...
        self.positions.insert_many([
            ...
            {"id": 103, "position_name": "Scary Movie", "tag": ["horror", "movies"], "categories": ["horror", "movies"]},
    ...
    def test_get_uniq_id(self):
        uniq_id = User.get_uniq_id()
        self.assertEqual(uniq_id, 4)
        # Добавим пользователя и проверим снова
    ...
    def test_add_like_to_user_category_already_liked_or_disliked(self):
        # "sports" уже в лайках у Alice, "horror" уже в дизлайках у Bob
        User.add_like_to_user(1, 101)
