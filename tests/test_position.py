...
class TestPosition(unittest.TestCase):
    ...
    def test_read_file(self):
        ...
        self.assertEqual(positions[0].name, "Gin - Gilbeys London, Dry")  # Проверяем имя первой позиции
        self.assertEqual(positions[1].tags, ["horror movies", "music"])  # Проверяем теги второй позиции
    ...
    def test_get_position_by_id(self):
        ...
        self.assertEqual(position.name, "Gin - Gilbeys London, Dry")  # Проверка существующей позиции

        position = Position.get_position_by_id(2)
        self.assertIsNotNone(position)
        self.assertEqual(position.name, "Shrimp - 100 / 200 Cold Water")  # Проверка второй позиции
    ...
    def test_get_recommend_position(self):
        ...
        self.assertEqual(recommended_positions[0].name, "Gin - Gilbeys London, Dry")
